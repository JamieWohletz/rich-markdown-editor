...
import { addColumnAfter, addColumnBefore, deleteColumn, deleteRow, deleteTable, setCellAttr, toggleHeaderCell, toggleHeaderColumn, toggleHeaderRow } from "prosemirror-tables";
